...
class TestRepresentation(object):
    ...
    def test_representation_value(self, r):
        ...
        assert isinstance(
            Value(valueType="lala", value=1.0, comments=None, date=datetime.datetime.now(), location=[45, 55],
                  qoc=newQoC), Value) == True
    ...
    def test_representation_log(self, r):
        assert isinstance(Log(logType="ERROR", content="lalala", details="lalala", date=datetime.datetime.now()),
                          Log) == True